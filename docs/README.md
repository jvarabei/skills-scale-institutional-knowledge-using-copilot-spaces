...
Roles and responsibilities are explicit so that handoffs and ownership remain clear: Project Managers coordinate delivery, schedules, risk registers, and stakeholder communications; Product Managers own outcomes, prioritize the backlog, and measure success; Developers implement and test; Scrum Masters facilitate agile processes and remove impediments; UX Designers ensure usable, accessible experiences; Technical Writers maintain clear documentation; QA validates acceptance criteria and release readiness; stakeholders (Sales, Support, Compliance) provide input and approvals. Key artifacts (One-pagers, roadmaps, backlogs, risk registers, and retrospectives) anchor decisions and reporting.
...
- Cross-Functional Collaboration Guide — docs/octoacme-cross-functional-collaboration.md
- Stakeholder Communication Map — docs/octoacme-stakeholder-communication-map.md

### Checklists & Templates
- Role Handoff Checklist — docs/octoacme-role-handoff-checklist.md
